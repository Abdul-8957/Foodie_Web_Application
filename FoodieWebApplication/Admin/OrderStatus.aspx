<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="OrderStatus.aspx.cs" Inherits="FoodieWebApplication.Admin.OrderStatus" %>
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <div class="row">
                                                    ...
                                                    <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lbEdit" runat="server" Text="Edit" CssClass=" badge badge-primary mr-1" CommandArgument='<%# Eval("OrderId") %>' CommandName="edit"> <i class="ti-pencil"></i></asp:LinkButton>
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-4 mobile-inputs">
                                             ...
                                             <div>
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="rfvOrderStatus" runat="server" ErrorMessage="Order Status is required" ForeColor="Red" SetFocusOnError="true" Display="Dynamic" ControlToValidate="ddlOrderStatus" InitialValue="0"></asp:RequiredFieldValidator>
