<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="FoodieWebApplication.User.Cart" %>
            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
               <HeaderTemplate>
                ...
                <ItemTemplate>
                    ...
                    <td>
                        <img alt="" width="60" src="<%# Utils.GetImageUrl(Eval("Image")) %>" />
                    </td>
                    <td>
                        <asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Price") %>'></asp:Label>&nbsp;Rupees
                   ...
                   <td>
                    ...
                    <td>
                         <asp:Label ID="lblTotalPrice" runat="server" ></asp:Label>&nbsp;Rupees
                    </td>
                    <td>
                        <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove" CommandArgument='<%# Eval("ProductId") %>' OnClientClick="return confirm('Do you want to remove this item from cart?');"><i class="fa fa-close"></i></asp:LinkButton>
                    </td>
                        </tr>
                </ItemTemplate>
                <FooterTemplate>
                   <tr>
                       ...
                       <td><% Response.Write(Session["grandTotalPrice"]); %>&nbsp;Rupees</td>
                       <td></td>
                   </tr>
                    <tr>
                        ...
                        <td>
                             <asp:LinkButton ID="lbCheckOut" runat="server" CommandName="checkOut" CssClass="btn btn-success">CkeckOut
