<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="FoodieWebApplication.User.Contact" %>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                             <asp:RequiredFieldValidator runat="server" ID="rfvSubject" ErrorMessage="Subject is required" ControlToValidate="txtSubject" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:TextBox runat="server" ID="txtSubject" CssClass="form-control" placeholder="Your Subject"></asp:TextBox>
                       
                        </div>
                        <div>
                             <asp:RequiredFieldValidator runat="server" ID="rfvMessage" ErrorMessage="Message is required" ControlToValidate="txtMessage" ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:TextBox runat="server" ID="txtMessage" CssClass="form-control" placeholder="Enter your Query/Feedback" TextMode="MultiLine"></asp:TextBox>
